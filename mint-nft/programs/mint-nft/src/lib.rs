...
declare_id!("HHHLVvTBydJjYBvonpoQX5cA1upVe6dixwwiYPQFmtbi");
...
pub mod mint_nft {
    ...
    pub fn create_token(
        ...
        msg!("Token creation process completed successfully.");
    ...
    pub fn mint_token(
        ...
        let metadata_title: String = String::from("Test_NFT");
        let metadata_symbol: String= String::from("TNFT");
        let metadata_uri: String = String::from("https://raw.githubusercontent.com/Coding-and-Crypto/Solana-NFT-Marketplace/master/assets/example.json");
        invoke(
